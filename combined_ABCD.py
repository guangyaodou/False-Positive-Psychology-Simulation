...
for i in range(num_simulation):
    ...
    print(f"Combined_ABCD is running {i}th simulation")
    ...
    condition = np.random.choice(3, observations_per_cell)
    ...
    additional_condition = np.random.choice(3, additional_size)
    ...
    if ttest_ind(data[data["conditions"] == 0]["dependent_var1"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(data[data["conditions"] == 1]["dependent_var1"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(data[data["conditions"] == 2]["dependent_var1"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(data[data["conditions"] == 0]["dependent_var2"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(data[data["conditions"] == 1]["dependent_var2"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(data[data["conditions"] == 2]["dependent_var2"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(data[data["conditions"] == 0]["average_var3"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(data[data["conditions"] == 1]["average_var3"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(data[data["conditions"] == 2]["average_var3"].to_numpy(), null_hypothesis)[1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 0]["dependent_var1"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 1]["dependent_var1"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 2]["dependent_var1"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 0]["dependent_var2"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 1]["dependent_var2"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 2]["dependent_var2"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 0]["average_var3"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 1]["average_var3"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
    elif ttest_ind(additional_data[additional_data["conditions"] == 3]["average_var3"].to_numpy(), null_hypothesis)[
        1] < alpha:
        rejection += 1
